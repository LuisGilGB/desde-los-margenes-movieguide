...
const mapDispatchToProps = (dispatch, props) => ({
  goToMovieDetail: (movieId) =>
    dispatch(
      navLogicActionCreators.navigateWithPush(ROUTES.MOVIES.DETAIL, {
        movieId,
      }),
    ),
  loadMovies: () => dispatch(actionCreators.loadMovies()),
  loadMovieDetail: (movieId) =>
    dispatch(actionCreators.loadMovieDetail(movieId)),
});

export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MoviesViewport),
);
